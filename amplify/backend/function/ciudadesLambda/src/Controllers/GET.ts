...
async function obtenerTodasLasCiudades(req: Request, res: Response) {
    let results;
    try {
...
async function obtenerTodasLasCiudadesPorDepartamento(req: Request, res: Response) {
    let results;
    try {
...
async function obtenerTodasLasCiudadesConAlMenosUnaLocacion(req: Request, res: Response) {
    let results;
    try {
...
async function obtenerTopPorCiudad(req: Request, res: Response) {
    let {ciudadid}: any = req.query;
