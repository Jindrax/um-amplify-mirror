...
async function obtenerTodasLasUnidadesAdministrativas(req: Request, res: Response) {
    let results;
    try {
...
async function obtenerTopPorUnidadAdministrativa(req: Request, res: Response) {
    let {unidadadminid}: any = req.query;
