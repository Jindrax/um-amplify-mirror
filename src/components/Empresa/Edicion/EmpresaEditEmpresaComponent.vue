  ...
  <q-card>
    <q-card-section>
      <div class="column items-start justify-start">
        ...
        <div class="row full-width">
          <div class="col row items-center">
            <q-btn class="empresa-advance-btn full-width" label="Editar Horario" @click="scheduleDialog=!scheduleDialog"/>
          </div>
        </div>
        <div class="col-auto row full-width">
      ...
      <div class="row full-width items-end justify-end q-gutter-sm">
        ...
        <q-btn class="col-auto empresa-advance-btn" label="Guardar" @click="actualizarLocacion"/>
      </div>
    </q-card-section>
  </q-card>
</template>
